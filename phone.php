...
$sql = "SELECT * FROM telemovelLoja LIMIT 100"; /*gets acessories info from db*/
...
<h1 style="text-align:center; padding:10px; font-family: 'Roboto', sans-serif;font-weight: lighter; font-size:56px ; ">Telemóveis</h1>
                            ...
                            <table id="movimentos" style="width:100%" class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($motor as $items) {
                                        $name_access = $items['Nome'];
                                        $price_access = $items['Preco'];
                                        $img_access = $items['img'];
                                        $tamanho_access = $items['Polegadas'];
                                        $ram_access = $items['Ram'];
                                        $disco_access = $items['Disco'];
                                        $cor_access = $items['Cor'];
                                        echo '<tr>
                                            <td>
                                                <img class="img" src="assets/images/t/' . $img_access . '.jpg"" alt="' . $name_access . '"><br><br>
                                                <div class="produto">
                                                ...
                                                <h4 class="prop">Caracteristicas:</h4>
                                                <p>Polegadas: '.$tamanho_access. '<br>
                                                Disco: '.$disco_access. '<br>
                                                Ram: '.$ram_access. '<br>
                                                Cor: '.$cor_access. '</p>
                                                </div>
